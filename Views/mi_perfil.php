...
?>
<title>InFashion | Mi perfil  </title>
                  ...
                  <div class="row">
                    <div class="col-8">
                      ...
                      <ul class="ml-4 mb-0 fa-ul text-muted">
                        <li class="small"><span class="fa-li"><i class="fas fa-address-card"></i></span>CURP: <span id='curp'></span></li>
                    ...
                    <div class="col-4 text-center">
                      <img src="../Util/img/user.png" alt="user-avatar" class="img-circle img-fluid">
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="card card-light ">
                ...
                <div class="card-body pt-0 mt-3">
                  <div class="row">
                    ...
                    <div class="col-4 text-center">
                      <img src="../Util/img/gps.png" alt="user-avatar" class="img-circle img-fluid">
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="card-body pt-0 mt-3">
                  <div class="row">
                    ...
                    <div class="col-4 text-center">
                      <img src="../Util/img/credit-card.png" alt="user-avatar" class="img-circle img-fluid">
                    </div>
                  </div>
                </div>
              </div>
